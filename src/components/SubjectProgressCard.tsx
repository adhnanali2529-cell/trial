    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-xs border border-slate-100 dark:border-slate-800">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-semibold text-slate-800 dark:text-slate-200">Subject Weekly Goals</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Track study hours against weekly targets</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-5">
        {subjects.length === 0 ? (
          <div className="text-center py-8 text-slate-400 dark:text-slate-500">
            <BookOpen size={32} className="mx-auto mb-2 opacity-55" />
